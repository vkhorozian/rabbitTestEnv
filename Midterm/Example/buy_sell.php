...
<div class="container">
    ...
    <form  method="post" action = "sell.php">
        <div class="form-group">
            <div class="cols-lg-6">
                <input class=form-control type=text name="sell_amount" id="sell_amount" required="required" placeholder="Sell Amount" value="<?php echo $_SESSION['sell'] = "USD"; ?>">
            </div>
        </div>
    ...
    <form  method="post" action = "buy.php">
        <div class="form-group">
            <div class="cols-lg-6">
                <input class=form-control type=text name="buy_amount" id="buy_amount" required="required" placeholder="Buy Amount" value="<?php echo $_SESSION['buy'] = "$cleansed_symbol"; ?>" >
            </div>
        </div>
